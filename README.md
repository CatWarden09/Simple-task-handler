...
Запускает все процессы с меткой для исключения в названии папки (см. [**Первый запуск](https://github.com/CatWarden09/Simple-task-handler#первый-запуск))
...
- ~~Запуск/завершение программ из только подпапок с метками для исключения~~ ✅
- ~~Возможность указывать название .exe-файла (сейчас захардкожено для Telegram)~~ ✅
- Возможность менять данные в .env через саму программу, а не вручную
- GUI

...
## Крактое описание
Simple task handler - это программа для управлениями копиями программ, расположенных в одной родительской директории.
...
## 💡 TBD
- Запуск единичной копии программы (одним числом, без диапазона)
- Запуск только программ из подпапок с определенными метками (кроме числовых индексов)
